...
{
    //<History Author = 'Hassan Abbas' Date='2023-08-07' Version="1.0" Branch="master"> Added Extension for Filtering the list of Radzen Grid using free input search</History>
    public class RadzenGridSearchExtension
    {
