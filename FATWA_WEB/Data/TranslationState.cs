...
namespace FATWA_WEB.Data
{
    ...
    public class TranslationState
    {
        ...
        public string Translate(string stringToTranslate, string lang)
        {
            try
            {
                if (!string.IsNullOrEmpty(stringToTranslate))
                {
                    ...
                    if (translation != null)
                    {
                        stringToTranslate = lang == "en-US" ? translation.Value_En : translation.Value_Ar;
                    }
                }
                return stringToTranslate;
            }
        ...
        //<History Author = 'Hassan Abbas' Date='2024-01-04' Version="1.0" Branch="master"> Check to translate the grid if not null</History>
