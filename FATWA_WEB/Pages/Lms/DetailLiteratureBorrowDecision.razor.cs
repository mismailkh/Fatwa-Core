...
{
    public partial class DetailLiteratureBorrowDecision : ComponentBase
    {
        ...
        protected async Task FormSubmit(LmsLiteratureBorrowDetail args)
        {
            try
            {
                ...
                if (args.ExtensionApprovalStatus == (int)FATWA_GENERAL.Helper.Enum.BorrowExtensionApprovalStatus.Approve)
                {
                ...
                else if (args.ExtensionApprovalStatus == (int)FATWA_GENERAL.Helper.Enum.BorrowExtensionApprovalStatus.Reject)
                {
                ...
                {
                    var response = await lmsLiteratureBorrowDetailService.UpdateLiteratureBorrowApprovalStatus(int.Parse(BorrowId), literatureBorrowApproveReject);
