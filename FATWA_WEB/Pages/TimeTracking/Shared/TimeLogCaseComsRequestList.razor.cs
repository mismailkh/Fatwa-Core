...
namespace FATWA_WEB.Pages.TimeTracking.Shared
{
    public partial class TimeLogCaseComsRequestList : ComponentBase
    {
        ...
        protected async Task SubmitAdvanceSearch()
        {
            ...
            if (string.IsNullOrEmpty(advanceSearchCOMSVM.RequestNumber)
                && !advanceSearchCOMSVM.StatusId.HasValue && string.IsNullOrWhiteSpace(advanceSearchCOMSVM.Subject)
