...
namespace FATWA_WEB.Services.MojStatistics
{
    ...
    public partial class MojStatisticsDashboardService
    {
        ...
        #endregion
        #region Constructor
        public MojStatisticsDashboardService(IConfiguration config, ILocalStorageService _browserStorage, TranslationState _translationState)
        {
            _config = config;
        ...
        public async Task<ApiCallResponse> GetMOJStatisticDashboardList(MojStatsAdvanceSearchStatisticesVM advanceSearchVM)
        {
            try
            {
                var request = new HttpRequestMessage(HttpMethod.Post, _config.GetValue<string>("ODRP:Moj_Stats_Api_Url") + "/MojStatistics/GetJudgmentsCases");
                ...
                {
                    var content = await response.Content.ReadFromJsonAsync<IEnumerable<MojStatsDasboardVM>>();
        ...
        public async Task<ApiCallResponse> GetMOJStatisticsNewRegisteredCase(MojStatsAdvanceSearchStatisticesVM advanceSearchVM)
        {
            try
            {
                var request = new HttpRequestMessage(HttpMethod.Post, _config.GetValue<string>("ODRP:Moj_Stats_Api_Url") + "/MojStatistics/GetRegisteredCases");
                var postBody = advanceSearchVM;
                request.Content = new StringContent(System.Text.Json.JsonSerializer.Serialize(postBody), Encoding.UTF8, "application/json");
                //request.Headers.Authorization = new AuthenticationHeaderValue("Bearer", await browserStorage.GetItemAsync<string>("Token"));
                var response = await new HttpClient().SendAsync(request);
                if (response.IsSuccessStatusCode)
                {
                    var content = await response.Content.ReadFromJsonAsync<IEnumerable<MojStatsRegisteredDasboardVM>>();
                    return new ApiCallResponse { StatusCode = response.StatusCode, IsSuccessStatusCode = response.IsSuccessStatusCode, ResultData = content };
                }
                else
                {
        ...
        public async Task<ApiCallResponse> GetGovernmentEntities()
        {
            try
            {
                var request2 = new HttpRequestMessage(HttpMethod.Get, _config.GetValue<string>("ODRP:Moj_Stats_Api_Url") + "/MojStatistics/GetGovernmentEntities");
        ...
        public async Task<ApiCallResponse> Getsatisticprocesslogs()
        {
            try
            {
                var request = new HttpRequestMessage(HttpMethod.Get, _config.GetValue<string>("ODRP:Moj_Stats_Api_Url") + "/MojStatistics/GetRPAStatisticsExtractCANsLogs");
                //request2.Headers.Authorization = new AuthenticationHeaderValue("Bearer", await browserStorage.GetItemAsync<string>("Token"));
                var response = await new HttpClient().SendAsync(request);
                if (response.IsSuccessStatusCode)
                {
        ...
        public async Task<ApiCallResponse> GetAutomatedCaseNumberbyEntityId(int EntityId, int CaseSide, string Year)
        {
            try
            {
                var request = new HttpRequestMessage(HttpMethod.Get, _config.GetValue<string>("ODRP:Moj_Stats_Api_Url") + "/MojStatistics/GetAutomatedCaseNumber?EntityId=" + EntityId + "&CaseSide=" + CaseSide + "&Year=" + Year);
                var response = await new HttpClient().SendAsync(request);
                if (response.IsSuccessStatusCode)
                {
        ...
        public async Task<ApiCallResponse> GetJudgementsDetails(string CaseAutomatedNumber)
        {
            try
            {
                var request = new HttpRequestMessage(HttpMethod.Get, _config.GetValue<string>("ODRP:Moj_Stats_Api_Url") + "/MojStatistics/GetJudgementsDetailsByCaseAutomatedNumber?CaseAutomatedNumber=" + CaseAutomatedNumber);
                var response = await new HttpClient().SendAsync(request);
                if (response.IsSuccessStatusCode)
                {
        ...
        public async Task<ApiCallResponse> GetJudgementsYaers(int EntityId, int CaseSide)
        {
            try
            {
                var request = new HttpRequestMessage(HttpMethod.Get, _config.GetValue<string>("ODRP:Moj_Stats_Api_Url") + "/MojStatistics/GetJudgementsYaers?EntityId=" + EntityId + "&CaseSide=" + CaseSide);
                var response = await new HttpClient().SendAsync(request);
                if (response.IsSuccessStatusCode)
                {
        ...
        public async Task<ApiCallResponse> GetPartiesDetails(string CaseAutomatedNumber)
        {
            try
            {
                var request = new HttpRequestMessage(HttpMethod.Get, _config.GetValue<string>("ODRP:Moj_Stats_Api_Url") + "/MojStatistics/GetPartiesDetailsByCaseAutomatedNumber?CaseAutomatedNumber=" + CaseAutomatedNumber);
                var response = await new HttpClient().SendAsync(request);
                if (response.IsSuccessStatusCode)
                {
        ...
        public async Task<ApiCallResponse> GetFilesDetails(string CaseAutomatedNumber)
        {
            try
            {
                var request = new HttpRequestMessage(HttpMethod.Get, _config.GetValue<string>("ODRP:Moj_Stats_Api_Url") + "/MojStatistics/GetFilesDetailsByCaseAutomatedNumber?CaseAutomatedNumber=" + CaseAutomatedNumber);
                var response = await new HttpClient().SendAsync(request);
                if (response.IsSuccessStatusCode)
                {
        ...
        public async Task<ApiCallResponse> GetAttachment(int FileId)
        {
            try
            {
                var request = new HttpRequestMessage(HttpMethod.Get, _config.GetValue<string>("ODRP:Moj_Stats_Api_Url") + "/MojStatistics/GetAttachment?FileId=" + FileId);
        ...
        public async Task<ApiCallResponse> GetCaseDetails(string CaseAutomatedNumber)
        {
            try
            {
                var request = new HttpRequestMessage(HttpMethod.Get, _config.GetValue<string>("ODRP:Moj_Stats_Api_Url") + "/MojStatistics/GetCaseDetail?CaseAutomatedNumber=" + CaseAutomatedNumber);
                var response = await new HttpClient().SendAsync(request);
                if (response.IsSuccessStatusCode)
                {
        ...
        public async Task<ApiCallResponse> GetHearingDetails(string CaseAutomatedNumber)
        {
            try
            {
                var request = new HttpRequestMessage(HttpMethod.Get, _config.GetValue<string>("ODRP:Moj_Stats_Api_Url") + "/MojStatistics/GetHearingDetails?CaseAutomatedNumber=" + CaseAutomatedNumber);
                var response = await new HttpClient().SendAsync(request);
                if (response.IsSuccessStatusCode)
                {
        ...
        public async Task<ApiCallResponse> GetExecutionDetails(string CaseAutomatedNumber)
        {
            try
            {
                var request = new HttpRequestMessage(HttpMethod.Get, _config.GetValue<string>("ODRP:Moj_Stats_Api_Url") + "/MojStatistics/GetExecutionDetails?CaseAutomatedNumber=" + CaseAutomatedNumber);
                var response = await new HttpClient().SendAsync(request);
                if (response.IsSuccessStatusCode)
                {
        ...
        public async Task<ApiCallResponse> GetAccouncementsDetails(string CaseAutomatedNumber)
        {
            try
            {
                var request = new HttpRequestMessage(HttpMethod.Get, _config.GetValue<string>("ODRP:Moj_Stats_Api_Url") + "/MojStatistics/GetAnnouncementsDetails?CaseAutomatedNumber=" + CaseAutomatedNumber);
                var response = await new HttpClient().SendAsync(request);
                if (response.IsSuccessStatusCode)
                {
        ...
        public async Task<ApiCallResponse> GetExecutionFinancialDetails(int ExecutionId)
        {
            try
            {
                var request = new HttpRequestMessage(HttpMethod.Get, _config.GetValue<string>("ODRP:Moj_Stats_Api_Url") + "/MojStatistics/GetExecutionFinancialDetails?ExecutionId=" + ExecutionId);
                var response = await new HttpClient().SendAsync(request);
                if (response.IsSuccessStatusCode)
                {
        ...
        public async Task<ApiCallResponse> GetExecutionProceduresDetails(int ExecutionId)
        {
            try
            {
                var request = new HttpRequestMessage(HttpMethod.Get, _config.GetValue<string>("ODRP:Moj_Stats_Api_Url") + "/MojStatistics/GetExecutionProceduresDetails?ExecutionId=" + ExecutionId);
                var response = await new HttpClient().SendAsync(request);
                if (response.IsSuccessStatusCode)
                {
