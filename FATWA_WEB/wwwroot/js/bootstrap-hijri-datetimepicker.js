    ...
    var hijriDatePicker = function (element, options) {
        ...
        var picker = {},
            ...
            getTemplate = function () {
                var template = $('<div style="border:1px solid #E6E4E4 !important; position:absolute; z-index: 2147483647; background:#ffff">').addClass('bootstrap-datetimepicker-widget dropdown-menu'),
                    dateView = $('<div>').addClass('datepicker').append(getDatePickerTemplate()),
                    timeView = $('<div>').addClass('timepicker').append(getTimePickerTemplate()),
                    content = $('<ul style="padding: 0px !important">').addClass('list-unstyled'),
