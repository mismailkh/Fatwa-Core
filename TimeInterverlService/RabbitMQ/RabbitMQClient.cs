...
namespace FATWATIMEINTERVALSERVICES.RabbitMQ
{
    public class RabbitMQClient
    {
        ...
        private void CreateConnection()
        {
            try
            {
                ...
                _connection = _factory.CreateConnection("WorkerService_Producer");
        ...
        public async Task<bool> SendMessage(object obj, string RoutingKey, bool IsWSForPublishdedMessage)
        {
            try
            {
                CreateConnection();
